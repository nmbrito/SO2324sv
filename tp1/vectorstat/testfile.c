...
int main(int argc, char *argv[])
{
    ...
    long svNumber[1] = 0;                   // Number of items written in sv
    ...
    for(int ongoingProcesses = 0; ongoingProcesses < numberProcesses; ongoingProcesses++)
    {
        ...
        else if(forker == CHILD) // Child work
        {
            ...
            write(pipesfds[WRITE], svNumber, sizeof(long)); //se a estratégia do -1 for usada, isto desaparece
    ...
    //arraySubValues = realloc(arraySubValues, sizeof(int)*v_sz);
